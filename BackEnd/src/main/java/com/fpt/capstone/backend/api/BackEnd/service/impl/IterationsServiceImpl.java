...
public class IterationsServiceImpl implements InterationsService {
    ...
    @Override
    public Page<IterationsListDTO> listBy(String name, int page, int per_page) throws Exception {
        Pageable pageable = PageRequest.of(page - 1, per_page);
        Page<IterationsListDTO> iterations = iterationsRepository.search(name, pageable);
        return iterations;
    }
